...
class S3(LeoStream):
    ...
    def __init__(self, config: Cfg, bot_id: str, queue_name: str):
        ...
        self.max_record_size = int(config.value_or_else('STORAGE_MAX_RECORD_SIZE', str(1024 * 900)))
        self.max_batch_size = int(config.value_or_else('STORAGE_MAX_BATCH_SIZE', str(1024 * 900)))
        self.max_batch_records = int(config.value_or_else('STORAGE_MAX_BATCH_RECORDS', str(1000)))
        self.max_batch_age = int(config.value_or_else('STORAGE_MAX_BATCH_AGE', str(200)))
        self.max_attempts = int(config.value_or_else('STORAGE_MAX_UPLOAD_ATTEMPTS', str(10)))
